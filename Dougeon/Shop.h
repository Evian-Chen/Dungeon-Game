 ...
 * Description: This file contains the definition of the Shop class. It includes
                 attributes and methods for handling shop operations in a game,
                 including managing inventory items and their prices, as well as
                 the shop's position on a map.
 ***********************************************************************/
